...
class ChatState(BaseState):
    ...
    # def answer(self):
    #     """
    #     사용자의 질문에 답변하는 이벤트 핸들러입니다.
    #     초기 버전은 AI 없이 사용자의 입력을 그대로 따라하는 '에코' 기능을 수행합니다.
    #     """
    #     # 입력이 비어있으면 아무 작업도 하지 않습니다.
    #     if not self.question.strip():
    #         return
    ...
    #     # 간단한 에코 응답을 채팅 기록에 추가합니다.
    #     self.chat_history.append(
    #         Message(role="assistant", content=f"You said: {self.question}")
    #     )

    #     # 입력 필드를 비웁니다.
    #     # 이 상태 변경은 UI에 자동으로 반영됩니다.
    #     self.question = ""
